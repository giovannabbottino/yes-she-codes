...
(deftest validate-test
  (testing "Testa se a compra enviada é realmente valida"
    (is (s/validate Compra (Compra. (t/local-date "2022-01-01")	129.90M "outback" "alimentação" 1234123412341234))))
  (testing "Teste multipla vezes para compra invalida"
    (are [parametro-compra] (thrown? Exception (s/validate Compra parametro-compra))
                             [(Compra. nil	129.90M "outback" "alimentação" 1234123412341234)
                              (Compra. (t/local-date "2022-01-01")	-129.90M "outback" "alimentação" 1234123412341234)
                              (Compra. (t/local-date "2022-01-01")	129.90M "" "alimentação" 1234123412341234)
                              (Compra. (t/local-date "2022-01-01")	129.90M "" "passeio" 1234123412341234)
                              (Compra. (t/local-date "2022-01-01")	129.90M "outback" "alimentação" -1234123412341234)
                              ])))